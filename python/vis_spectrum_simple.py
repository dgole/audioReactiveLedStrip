...
raw_filt = ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.5, alpha_rise=0.5)
...
mel_gain = ExpFilter(np.tile(1e-1, config.N_FFT_BINS), alpha_decay=0.02, alpha_rise=0.99)
mel_smoothing = ExpFilter(np.tile(1e-1, config.N_FFT_BINS), alpha_decay=0.99, alpha_rise=0.99)
