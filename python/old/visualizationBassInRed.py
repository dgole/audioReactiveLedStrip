...
r_filt = dsp.ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.5, alpha_rise=0.9)
g_filt = dsp.ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.5, alpha_rise=0.9)
b_filt = dsp.ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.5, alpha_rise=0.9)
...
def visualize_spectrum(y):
    ...
    #r[:min(bassPixels, config.N_PIXELS)] = 0.5
