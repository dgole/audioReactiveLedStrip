...
r_filt = dsp.ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.2, alpha_rise=0.5)
g_filt = dsp.ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.2, alpha_rise=0.5)
b_filt = dsp.ExpFilter(np.tile(0.01, config.N_PIXELS), alpha_decay=0.2, alpha_rise=0.5)
