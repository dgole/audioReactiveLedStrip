...
ledFilt = tools.ExpFilter(np.tile(0.01, local_N_PIXELS), alpha_decay=0.1, alpha_rise=0.5)
_prev_spectrum = np.tile(0.01, local_N_PIXELS)
mel_gain = tools.ExpFilter(np.tile(1e-1, config.N_FFT_BINS), alpha_decay=0.05, alpha_rise=0.5)
